...
export default function Sidebar({ role, onSelectPage, selectedPage }) {
  ...
  return (
    <aside className="w-64 bg-white dark:bg-gray-800 min-h-screen border-r dark:border-gray-700">
      <div className="p-6 text-2xl font-bold border-b dark:border-gray-700">Delivery App</div>
        ...
        {menuItems.map(item => (
          <button
            ...
            className={`flex items-center gap-3 p-2 w-full rounded ${
              selectedPage === item.key ? "bg-gray-200 dark:bg-gray-700" : ""
            }`}
          >
